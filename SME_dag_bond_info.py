...
with models.DAG(
    "sme_bond_info",  # The id you will see in the DAG airflow page
    ...
    for rp in raw_prefixes:
        ...
        with TaskGroup(group_id=f"{ed_code}_bond_info") as bond_info_tg:
            bond_info_profile_task = DataprocCreateBatchOperator(
                ...
                batch_id=f"{ed_code.lower()}_bond_info_profile",
            )
            bond_info_bronze_task = DataprocCreateBatchOperator(
                ...
                batch_id=f"{ed_code.lower()}_bond_info_bronze",
            )
            bond_info_silver_task = DataprocCreateBatchOperator(
                ...
                batch_id=f"{ed_code.lower()}_bond_info_silver",
            )
        ...
        (start >> bond_info_tg >> clean_up_tg >> end)
